  ...
  return (
    <>
      <section className="product-slider">
        <button className="product-slider__btn">
          <svg
            width="13"
            height="23"
            viewBox="0 0 13 23"
        ...
        <img className="product-slider__img" src={single} alt="Продукт 1" />
        <button className="product-slider__btn product-slider__btn_r">
          <svg
            width="13"
            height="23"
            viewBox="0 0 13 23"
